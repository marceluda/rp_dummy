...
#h.add(name='dummy_mod_sq_on'      , val=0, rw=True, min_val=0 , max_val=1, signed=False, fpga_update=False, desc='Show Square Modulation')
#h.add(name='dummy_mod_harmonic_on', val=1, rw=True, min_val=0 , max_val=1, signed=False, fpga_update=False, desc='Show Harmonic Modulation')
