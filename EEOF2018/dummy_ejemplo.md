---
title: Código Verilog de ejemplo
subtitle: dummy_ejemplo
layout: page
mathjax: true
---
...
module dummy(
    ...
    muxer_reg5  #(.RES(14)) i_muxer5_scope1 (
        ...
        .in4  ( salida_pasabajos   ),
        .in5  ( salida_contador14  ),
        .in6  ( salida_promedio    ),
        .in7  ( cuadrada           ),
        .in8  ( cuadrada_pasabajos ),
        .in9  ( contador_mas_A_sat ),
        .in10 ( contador_mas_A_recortado     ),
        .in11 ( 14'b0     ),
        .in12 ( 14'b0     ),
        .in13 ( 14'b0     ),
        .in14 ( 14'b0     ),
